...
| --- | --- | --- |
| Table of Contents | Hover to expand | Displays a navigation panel with h1-h3 headings in the document (right side of preview, expands on mouse hover) |
...
- Hover over the Table of Contents to expand it and see the full navigation menu.
