...
| 機能名 | ショートカット | 説明 |
| --- | --- | --- |
| 見出し | ホバーで展開 | ドキュメント内のh1-h3見出しを含むナビゲーションパネルを表示（プレビュー右側、マウスホバーで展開） |
...
- 見出しパネルにマウスカーソルを合わせると展開され、完全なナビゲーションメニューが表示されます。
- 見出しパネル内の見出しをクリックすると、プレビュー内のそのセクションまでスムーズにスクロールします。
