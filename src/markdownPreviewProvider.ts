...
<head>
    ...
    <style>
        :root {
            ...
            /* Font Families */
            --font-sans: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans JP', Roboto, sans-serif;
            --font-mono: 'SF Mono', 'Cascadia Code', 'Fira Code', 'JetBrains Mono', Monaco, 'Roboto Mono', Consolas, monospace;
            --font-display: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans JP', Roboto, sans-serif;
        ...
        * {
        ...
        h1 {
            ...
            border-bottom: 2px solid var(--md-heading-border);
        }
        ...
        hr {
            ...
            border: none;
            border-top: 2px solid var(--md-heading-border);
            opacity: 0.6;
        }
        ...
        blockquote {
            border-left: 5px solid var(--md-quote-border);
